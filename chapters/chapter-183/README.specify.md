# Глава 183: Rust-Python FFI для квантовых вычислений

## Техническое задание

### Название главы
Rust-Python FFI для квантовых вычислений
...
### Описание
PyO3. Calling Qiskit from Rust. Performance benefits.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Rust-Python FFI для квантовых вычислений"
...
### Ключевые слова
`Rust-Python FFI для квантовых вычислений`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
