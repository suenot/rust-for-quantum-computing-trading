# Глава 024: Многопоточность - Каналы
...
### Описание
mpsc channels. Sender и Receiver. Коммуникация между компонентами торговой системы.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Многопоточность - Каналы"
...
### Ключевые слова
`Многопоточность - Каналы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
