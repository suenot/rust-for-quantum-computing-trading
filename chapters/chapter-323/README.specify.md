...
### Описание
Horizontal scaling. Vertical scaling. Auto-scaling. Capacity planning.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Scaling strategies"
...
### Ключевые слова
`Scaling strategies`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
