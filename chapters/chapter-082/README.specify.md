# Глава 082: Математика квантовых вычислений
...
### Описание
Комплексные числа. Векторные пространства. Нотация Дирака. Rust math libraries.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Математика квантовых вычислений"
...
### Ключевые слова
`Математика квантовых вычислений`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
