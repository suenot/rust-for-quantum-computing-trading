...
### Описание
Microsoft Azure Quantum. Workspace. Providers. Credits.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Azure Quantum - Обзор"
...
### Ключевые слова
`Azure Quantum - Обзор`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
