# Глава 090: Измерения в квантовых системах
...
### Описание
Measurement postulate. Projective measurement. Born rule. Rust measurement simulation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Измерения в квантовых системах"
...
### Ключевые слова
`Измерения в квантовых системах`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
