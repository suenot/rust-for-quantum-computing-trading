...
### Описание
FIX protocol basics. Message structure. Tags. Rust FIX парсер.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Протокол FIX"
...
### Ключевые слова
`Протокол FIX`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
