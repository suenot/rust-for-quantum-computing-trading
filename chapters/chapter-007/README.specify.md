# Глава 007: Времена жизни (Lifetimes)
...
### Описание
Аннотации времени жизни. Elision rules. Lifetime в структурах. Управление жизненным циклом рыночных данных.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Времена жизни (Lifetimes)"
...
### Ключевые слова
`Времена жизни (Lifetimes)`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
