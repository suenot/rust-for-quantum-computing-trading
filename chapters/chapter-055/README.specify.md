# Глава 055: Хранение рыночных данных
...
### Описание
Time-series databases. InfluxDB, TimescaleDB. Rust интеграция.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Хранение рыночных данных"
...
### Ключевые слова
`Хранение рыночных данных`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
