...
### Описание
Tokio экосистема. Runtime configuration. Spawn tasks. Асинхронные торговые боты.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Tokio Runtime"
...
### Ключевые слова
`Tokio Runtime`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
