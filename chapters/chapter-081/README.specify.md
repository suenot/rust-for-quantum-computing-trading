# Глава 081: Введение в квантовую механику
...
### Описание
Принципы квантовой механики. Волновая функция. Измерение. Суперпозиция.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Введение в квантовую механику"
...
### Ключевые слова
`Введение в квантовую механику`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
