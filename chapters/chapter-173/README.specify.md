...
### Описание
D-Wave Ocean. BQM. Embedding. Samplers.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Ocean SDK - D-Wave"
...
### Ключевые слова
`Ocean SDK - D-Wave`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
