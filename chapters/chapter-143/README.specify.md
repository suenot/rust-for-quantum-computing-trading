...
### Описание
Transpilation. Backend selection. Job submission. Results.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Terra основы"
...
### Ключевые слова
`Qiskit - Terra основы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
