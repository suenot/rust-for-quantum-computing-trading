...
### Описание
Position sizing. Stop-loss. Portfolio risk. Rust risk engine.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Risk Management"
...
### Ключевые слова
`Risk Management`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
