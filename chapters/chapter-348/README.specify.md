...
### Описание
Text encoding. Sentiment. Named entity. Summarization.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum для NLP"
...
### Ключевые слова
`Quantum для NLP`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
