...
### Описание
Quantum network architecture. QKD networks. Future vision.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовый интернет"
...
### Ключевые слова
`Квантовый интернет`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
