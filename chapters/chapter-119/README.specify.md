...
### Описание
Noisy devices. Error mitigation. Practical applications.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "NISQ эра"
...
### Ключевые слова
`NISQ эра`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
