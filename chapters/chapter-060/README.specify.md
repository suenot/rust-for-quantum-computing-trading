# Глава 060: Моделирование временных рядов
...
### Описание
ARIMA, GARCH. Stationarity. Rust библиотеки для временных рядов.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Моделирование временных рядов"
...
### Ключевые слова
`Моделирование временных рядов`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
