# Глава 013: Коллекции - HashMap и HashSet
...
### Описание
HashMap для словарей. HashSet для уникальных значений. Кэширование рыночных данных. Индексация по тикерам.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Коллекции - HashMap и HashSet"
...
### Ключевые слова
`Коллекции - HashMap и HashSet`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
