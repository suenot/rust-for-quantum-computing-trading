# Глава 212: Azure Quantum - Resource Estimation
...
### Описание
Fault-tolerant estimation. Resource counts. Planning.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Azure Quantum - Resource Estimation"
...
### Ключевые слова
`Azure Quantum - Resource Estimation`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
