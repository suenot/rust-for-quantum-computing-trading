# Глава 141: Qiskit - Установка и настройка

## Техническое задание

### Название главы
Qiskit - Установка и настройка
...
### Описание
IBM Qiskit SDK. Installation. Configuration. First quantum circuit.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Установка и настройка"
...
### Ключевые слова
`Qiskit - Установка и настройка`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
