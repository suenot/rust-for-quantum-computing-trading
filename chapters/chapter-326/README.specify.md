# Глава 326: Alerting и incident response
...
### Описание
Alert rules. On-call. Runbooks. Post-mortems.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Alerting и incident response"
...
### Ключевые слова
`Alerting и incident response`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
