# Глава 049: Рыночные данные - Level 1

## Техническое задание

### Название главы
Рыночные данные - Level 1
...
### Описание
Best bid/ask. Last trade. Volume. Парсинг L1 данных на Rust.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Рыночные данные - Level 1"
...
### Ключевые слова
`Рыночные данные - Level 1`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
