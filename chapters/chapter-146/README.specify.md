# Глава 146: Qiskit - Pulse level control

## Техническое задание

### Название главы
Qiskit - Pulse level control
...
### Описание
OpenPulse. Custom gates. Calibration.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Pulse level control"
...
### Ключевые слова
`Qiskit - Pulse level control`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
