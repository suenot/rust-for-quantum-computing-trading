...
### Описание
Quantum Cloud Services. Aspen-M. Quil. Compilation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Rigetti QCS"
...
### Ключевые слова
`Rigetti QCS`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
