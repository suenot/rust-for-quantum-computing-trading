# Глава 050: Рыночные данные - Level 2

## Техническое задание

### Название главы
Рыночные данные - Level 2
...
### Описание
Full order book. Market depth. Order book imbalance. Rust структуры данных.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Рыночные данные - Level 2"
...
### Ключевые слова
`Рыночные данные - Level 2`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
