# Глава 098: Алгоритм Гровера - Теория

## Техническое задание

### Название главы
Алгоритм Гровера - Теория
...
### Описание
Unstructured search. Quadratic speedup. Oracle design.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Алгоритм Гровера - Теория"
...
### Ключевые слова
`Алгоритм Гровера - Теория`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
