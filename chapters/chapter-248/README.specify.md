...
### Описание
CVA calculation. Exposure simulation. Quantum acceleration.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Counterparty Risk"
...
### Ключевые слова
`Counterparty Risk`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
