...
### Описание
Определение enum. Варианты с данными. Option и Result. Моделирование типов ордеров и состояний сделок.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Перечисления (Enums)"
...
### Ключевые слова
`Перечисления (Enums)`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
