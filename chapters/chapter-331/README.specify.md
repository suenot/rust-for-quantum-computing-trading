# Глава 331: Fault-tolerant quantum computing
...
### Описание
Logical qubits. Threshold theorem. Resource overhead.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Fault-tolerant quantum computing"
...
### Ключевые слова
`Fault-tolerant quantum computing`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
