...
### Описание
Vec<T> - создание, модификация, итерация. Хранение исторических ценовых данных. Эффективное управление памятью.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Коллекции - Vectors"
...
### Ключевые слова
`Коллекции - Vectors`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
