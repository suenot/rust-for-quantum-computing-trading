# Глава 144: Qiskit - Aer симуляторы

## Техническое задание

### Название главы
Qiskit - Aer симуляторы
...
### Описание
Statevector simulator. QASM simulator. Noise models.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Aer симуляторы"
...
### Ключевые слова
`Qiskit - Aer симуляторы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
