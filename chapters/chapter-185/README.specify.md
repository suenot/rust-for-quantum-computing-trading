# Глава 185: Silq - High-level quantum

## Техническое задание

### Название главы
Silq - High-level quantum
...
### Описание
Silq language. Automatic uncomputation. Type system.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Silq - High-level quantum"
...
### Ключевые слова
`Silq - High-level quantum`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
