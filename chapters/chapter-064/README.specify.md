...
### Описание
Sharpe ratio, Sortino, Max Drawdown. Rust расчёт метрик.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Бэктестинг - Метрики"
...
### Ключевые слова
`Бэктестинг - Метрики`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
