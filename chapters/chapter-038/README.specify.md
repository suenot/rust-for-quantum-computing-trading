# Глава 038: Числовые вычисления - nalgebra

## Техническое задание

### Название главы
Числовые вычисления - nalgebra
...
### Описание
Линейная алгебра. Матричные разложения. Применение в оптимизации портфеля.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Числовые вычисления - nalgebra"
...
### Ключевые слова
`Числовые вычисления - nalgebra`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
