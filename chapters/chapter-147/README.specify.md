...
### Описание
Qiskit Runtime primitives. Sampler. Estimator. Sessions.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Runtime"
...
### Ключевые слова
`Qiskit - Runtime`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
