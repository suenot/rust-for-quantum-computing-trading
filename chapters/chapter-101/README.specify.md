# Глава 101: QAOA - Quantum Approximate Optimization
...
### Описание
QAOA circuit. Variational parameters. Hybrid classical-quantum.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "QAOA - Quantum Approximate Optimization"
...
### Ключевые слова
`QAOA - Quantum Approximate Optimization`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
