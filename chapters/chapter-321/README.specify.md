...
### Описание
Backup strategies. Failover. RTO/RPO. Testing.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Disaster Recovery"
...
### Ключевые слова
`Disaster Recovery`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
