# Глава 338: Quantum natural gradient
...
### Описание
QNG optimization. Fisher information. Implementation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum natural gradient"
...
### Ключевые слова
`Quantum natural gradient`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
