# Глава 102: VQE - Variational Quantum Eigensolver
...
### Описание
Ansatz design. Parameter optimization. Chemistry applications.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "VQE - Variational Quantum Eigensolver"
...
### Ключевые слова
`VQE - Variational Quantum Eigensolver`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
