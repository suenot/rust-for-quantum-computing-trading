# Глава 115: Квантовая криптография
...
### Описание
BB84 protocol. QKD basics. Security proofs.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовая криптография"
...
### Ключевые слова
`Квантовая криптография`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
