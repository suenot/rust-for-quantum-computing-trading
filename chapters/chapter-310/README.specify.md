# Глава 310: Fuzzing для безопасности
...
### Описание
Cargo-fuzz. AFL. Security testing. Bug discovery.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Fuzzing для безопасности"
...
### Ключевые слова
`Fuzzing для безопасности`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
