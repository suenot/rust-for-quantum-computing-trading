# Глава 278: Ковариационная матрица
...
### Описание
Covariance estimation. Large portfolios. Quantum approach.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Ковариационная матрица"
...
### Ключевые слова
`Ковариационная матрица`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
