...
### Описание
Market, Limit, Stop orders. Условные ордера. Iceberg orders. Реализация на Rust.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Типы ордеров"
...
### Ключевые слова
`Типы ордеров`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
