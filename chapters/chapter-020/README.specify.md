...
### Описание
Box<T> для heap allocation. Рекурсивные типы. Большие структуры данных для order book.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Smart Pointers - Box"
...
### Ключевые слова
`Smart Pointers - Box`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
