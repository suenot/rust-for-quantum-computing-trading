...
### Описание
Обобщённые типы. Monomorphization. Где-клаузы (where clauses). Универсальные контейнеры для рыночных данных.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Generics"
...
### Ключевые слова
`Generics`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
