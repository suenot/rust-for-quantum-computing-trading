...
### Описание
Trapped ion qubits. IonQ, Quantinuum. Gate implementations.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Ионные ловушки"
...
### Ключевые слова
`Ионные ловушки`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
