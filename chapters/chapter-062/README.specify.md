# Глава 062: Бэктестинг - Обработка данных

## Техническое задание

### Название главы
Бэктестинг - Обработка данных
...
### Описание
Data cleaning. Corporate actions. Splits adjustments. Rust pipeline.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Бэктестинг - Обработка данных"
...
### Ключевые слова
`Бэктестинг - Обработка данных`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
