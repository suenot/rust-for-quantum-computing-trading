# Глава 126: Квантовые симуляторы
...
### Описание
State vector simulators. Density matrix simulators. Rust simulators.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовые симуляторы"
...
### Ключевые слова
`Квантовые симуляторы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
