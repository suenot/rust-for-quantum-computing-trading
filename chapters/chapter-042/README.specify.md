...
### Описание
Акции и их свойства. Биржи (NYSE, NASDAQ, MOEX). Индексы. Фундаментальный анализ.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Фондовый рынок"
...
### Ключевые слова
`Фондовый рынок`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
