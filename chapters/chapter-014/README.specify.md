...
### Описание
String vs &str. UTF-8 encoding. Парсинг финансовых сообщений. Работа с FIX протоколом.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Строки в Rust"
...
### Ключевые слова
`Строки в Rust`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
