# Глава 258: Quantum Reinforcement Learning
...
### Описание
QRL basics. Trading agent. Policy optimization.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum Reinforcement Learning"
...
### Ключевые слова
`Quantum Reinforcement Learning`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
