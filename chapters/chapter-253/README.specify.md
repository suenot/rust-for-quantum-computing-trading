# Глава 253: Quantum Generative Models
...
### Описание
QGAN. Synthetic data. Distribution learning.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum Generative Models"
...
### Ключевые слова
`Quantum Generative Models`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
