# Глава 025: Многопоточность - Синхронизация
...
### Описание
Mutex, RwLock, Condvar. Атомарные типы. Lock-free структуры для HFT.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Многопоточность - Синхронизация"
...
### Ключевые слова
`Многопоточность - Синхронизация`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
