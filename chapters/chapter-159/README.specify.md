...
### Описание
Q# language. Visual Studio integration. Basics.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Q# - Microsoft Quantum"
...
### Ключевые слова
`Q# - Microsoft Quantum`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
