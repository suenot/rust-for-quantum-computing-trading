# Глава 074: Market Microstructure
...
### Описание
Price formation. Information asymmetry. Adverse selection.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Market Microstructure"
...
### Ключевые слова
`Market Microstructure`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
