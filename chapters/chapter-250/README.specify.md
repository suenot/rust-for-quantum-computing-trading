# Глава 250: Quantum Feature Maps
...
### Описание
Feature encoding. Kernel trick. Financial features.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum Feature Maps"
...
### Ключевые слова
`Quantum Feature Maps`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
