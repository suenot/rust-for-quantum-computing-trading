# Глава 347: Multi-agent quantum systems
...
### Описание
Multi-agent RL. Game theory. Market simulation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Multi-agent quantum systems"
...
### Ключевые слова
`Multi-agent quantum systems`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
