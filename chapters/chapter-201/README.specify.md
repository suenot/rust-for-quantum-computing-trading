# Глава 201: AWS Braket - Rigetti integration

## Техническое задание

### Название главы
AWS Braket - Rigetti integration
...
### Описание
Superconducting access. Aspen processors. Quilc.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "AWS Braket - Rigetti integration"
...
### Ключевые слова
`AWS Braket - Rigetti integration`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
