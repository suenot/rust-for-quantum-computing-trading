# Глава 100: Квантовая оптимизация - Введение

## Техническое задание

### Название главы
Квантовая оптимизация - Введение
...
### Описание
Optimization problems. QUBO formulation. Ising model.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовая оптимизация - Введение"
...
### Ключевые слова
`Квантовая оптимизация - Введение`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
