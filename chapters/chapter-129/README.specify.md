...
### Описание
Decoherence mechanisms. T1, T2 times. Noise models.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Шум и декогеренция"
...
### Ключевые слова
`Шум и декогеренция`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
