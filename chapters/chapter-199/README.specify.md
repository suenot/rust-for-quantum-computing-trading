# Глава 199: AWS Braket - Hardware providers

## Техническое задание

### Название главы
AWS Braket - Hardware providers
...
### Описание
IonQ, Rigetti, IQM, QuEra, AQT. Device comparison.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "AWS Braket - Hardware providers"
...
### Ключевые слова
`AWS Braket - Hardware providers`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
