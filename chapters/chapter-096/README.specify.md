# Глава 096: Алгоритм Шора - Теория

## Техническое задание

### Название главы
Алгоритм Шора - Теория
...
### Описание
Factoring problem. Cryptographic implications. Mathematical foundation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Алгоритм Шора - Теория"
...
### Ключевые слова
`Алгоритм Шора - Теория`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
