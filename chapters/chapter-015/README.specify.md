...
### Описание
Iterator trait. Методы итераторов (map, filter, fold). Ленивые вычисления. Обработка потоков рыночных данных.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Итераторы"
...
### Ключевые слова
`Итераторы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
