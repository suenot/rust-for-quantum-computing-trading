# Глава 213: Azure Quantum - Optimization
...
### Описание
Azure Quantum Optimization. Solvers. Problem types.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Azure Quantum - Optimization"
...
### Ключевые слова
`Azure Quantum - Optimization`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
