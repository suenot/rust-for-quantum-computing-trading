# Глава 079: Monte Carlo Simulation
...
### Описание
Random number generation. Path simulation. Rust Monte Carlo.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Monte Carlo Simulation"
...
### Ключевые слова
`Monte Carlo Simulation`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
