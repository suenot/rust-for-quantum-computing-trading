# Глава 261: Market Making с квантовыми алгоритмами

## Техническое задание

### Название главы
Market Making с квантовыми алгоритмами
...
### Описание
Inventory optimization. Spread setting. Risk management.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Market Making с квантовыми алгоритмами"
...
### Ключевые слова
`Market Making с квантовыми алгоритмами`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
