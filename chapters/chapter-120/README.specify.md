# Глава 120: Квантовое превосходство
...
### Описание
Quantum supremacy experiments. Benchmarking. Current state.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовое превосходство"
...
### Ключевые слова
`Квантовое превосходство`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
