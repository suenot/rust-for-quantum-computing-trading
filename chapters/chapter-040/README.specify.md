# Глава 040: Сетевое программирование
...
### Описание
std::net. TCP/UDP. Соединение с биржевыми серверами. Socket programming.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Сетевое программирование"
...
### Ключевые слова
`Сетевое программирование`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
