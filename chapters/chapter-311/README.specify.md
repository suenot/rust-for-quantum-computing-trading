# Глава 311: Интеграционное тестирование
...
### Описание
End-to-end tests. Test environments. Data fixtures.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Интеграционное тестирование"
...
### Ключевые слова
`Интеграционное тестирование`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
