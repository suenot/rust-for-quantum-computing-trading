# Глава 067: Торговые стратегии - Mean Reversion

## Техническое задание

### Название главы
Торговые стратегии - Mean Reversion
...
### Описание
Statistical arbitrage. Pairs trading. Rust реализация.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Торговые стратегии - Mean Reversion"
...
### Ключевые слова
`Торговые стратегии - Mean Reversion`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
