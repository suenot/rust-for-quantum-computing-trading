# Глава 290: Логирование и трейсинг
...
### Описание
Structured logging. Distributed tracing. Debug support.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Логирование и трейсинг"
...
### Ключевые слова
`Логирование и трейсинг`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
