# Глава 186: Quipper - Functional quantum

## Техническое задание

### Название главы
Quipper - Functional quantum
...
### Описание
Haskell-based. Circuit description. Scalable programs.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quipper - Functional quantum"
...
### Ключевые слова
`Quipper - Functional quantum`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
