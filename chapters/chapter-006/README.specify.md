# Глава 006: Заимствование (Borrowing)
...
### Описание
Ссылки и заимствование. Мутабельные и иммутабельные ссылки. Правила заимствования. Избежание data races в торговых системах.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Заимствование (Borrowing)"
...
### Ключевые слова
`Заимствование (Borrowing)`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
