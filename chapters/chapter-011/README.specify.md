...
### Описание
Result и Option типы. Оператор ?. Propagation ошибок. Создание иерархии ошибок для торговой системы.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Обработка ошибок"
...
### Ключевые слова
`Обработка ошибок`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
