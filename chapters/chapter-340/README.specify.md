# Глава 340: Quantum reservoir computing
...
### Описание
Reservoir approach. Temporal data. Implementation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum reservoir computing"
...
### Ключевые слова
`Quantum reservoir computing`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
