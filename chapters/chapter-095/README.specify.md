# Глава 095: Квантовое преобразование Фурье
...
### Описание
QFT circuit. Phase estimation basis. Rust QFT implementation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовое преобразование Фурье"
...
### Ключевые слова
`Квантовое преобразование Фурье`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
