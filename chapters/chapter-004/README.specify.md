...
### Описание
Определение функций, параметры и возвращаемые значения. Организация кода в модули. Видимость (pub). Создание библиотеки для торговых операций.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Функции и модули"
...
### Ключевые слова
`Функции и модули`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
