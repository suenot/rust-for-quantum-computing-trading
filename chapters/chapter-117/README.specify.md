# Глава 117: Вариационные квантовые алгоритмы
...
### Описание
VQA framework. Cost functions. Optimizers.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Вариационные квантовые алгоритмы"
...
### Ключевые слова
`Вариационные квантовые алгоритмы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
