...
### Описание
Quantum Instruction Language. Gates. Memory. Control.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quil language"
...
### Ключевые слова
`Quil language`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
