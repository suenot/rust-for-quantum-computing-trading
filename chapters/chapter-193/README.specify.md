# Глава 193: IBM Quantum - Composer
...
### Описание
Visual circuit builder. Drag-and-drop. Export. Share.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "IBM Quantum - Composer"
...
### Ключевые слова
`IBM Quantum - Composer`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
