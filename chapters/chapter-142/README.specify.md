# Глава 142: Qiskit - Quantum Circuits
...
### Описание
QuantumCircuit class. Adding gates. Measurements. Visualization.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Quantum Circuits"
...
### Ключевые слова
`Qiskit - Quantum Circuits`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
