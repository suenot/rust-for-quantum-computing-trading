...
### Описание
Braket Python SDK. Circuits. Devices. Tasks.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Amazon Braket SDK"
...
### Ключевые слова
`Amazon Braket SDK`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
