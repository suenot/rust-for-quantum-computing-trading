...
### Описание
Classical control. Pulse gates. Timing. Subroutines.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "OpenQASM 3.0"
...
### Ключевые слова
`OpenQASM 3.0`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
