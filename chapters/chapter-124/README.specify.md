# Глава 124: Сверхпроводящие кубиты
...
### Описание
Transmon qubits. IBM, Google hardware. Cryogenic systems.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Сверхпроводящие кубиты"
...
### Ключевые слова
`Сверхпроводящие кубиты`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
