# Глава 219: Google Quantum - Research access

## Техническое задание

### Название главы
Google Quantum - Research access
...
### Описание
Partnership programs. Academic access. Publications.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Google Quantum - Research access"
...
### Ключевые слова
`Google Quantum - Research access`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
