...
### Описание
Oracle problems. Algorithm walkthrough. Rust implementation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Алгоритм Дойча-Йожи"
...
### Ключевые слова
`Алгоритм Дойча-Йожи`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
