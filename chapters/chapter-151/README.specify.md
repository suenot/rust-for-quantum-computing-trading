...
### Описание
Molecular simulation. Fermionic operators. Ground state.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Nature"
...
### Ключевые слова
`Qiskit - Nature`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
