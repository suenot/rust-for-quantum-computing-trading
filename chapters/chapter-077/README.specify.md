...
### Описание
CAPM, Fama-French. Factor investing. Rust factor analysis.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Factor Models"
...
### Ключевые слова
`Factor Models`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
