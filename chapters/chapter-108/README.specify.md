...
### Описание
Topological codes. Lattice surgery. Threshold theorem.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Поверхностные коды"
...
### Ключевые слова
`Поверхностные коды`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
