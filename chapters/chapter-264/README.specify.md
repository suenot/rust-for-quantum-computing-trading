# Глава 264: Многопериодная оптимизация
...
### Описание
Dynamic programming. Quantum approach. Rebalancing.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Многопериодная оптимизация"
...
### Ключевые слова
`Многопериодная оптимизация`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
