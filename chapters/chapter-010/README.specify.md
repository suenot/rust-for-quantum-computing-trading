...
### Описание
Match expressions. If let и while let. Destructuring. Обработка различных типов рыночных событий.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Pattern Matching"
...
### Ключевые слова
`Pattern Matching`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
