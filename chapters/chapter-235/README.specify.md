# Глава 235: Квантовая оптимизация портфеля - Теория

## Техническое задание

### Название главы
Квантовая оптимизация портфеля - Теория
...
### Описание
Markowitz on quantum. Constraints encoding. Objective function.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовая оптимизация портфеля - Теория"
...
### Ключевые слова
`Квантовая оптимизация портфеля - Теория`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
