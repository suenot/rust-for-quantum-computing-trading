...
### Описание
Hardware plugins. Simulators. Custom devices.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "PennyLane - Devices"
...
### Ключевые слова
`PennyLane - Devices`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
