...
### Описание
Candlestick data. Timeframe aggregation. Rust генератор свечей из тиков.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Свечи (OHLCV)"
...
### Ключевые слова
`Свечи (OHLCV)`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
