...
### Описание
PyQuil basics. Quilc compiler. QVM. Aspen processors.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "PyQuil - Rigetti"
...
### Ключевые слова
`PyQuil - Rigetti`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
