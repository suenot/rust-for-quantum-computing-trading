# Глава 022: Smart Pointers - RefCell и Mutex

## Техническое задание

### Название главы
Smart Pointers - RefCell и Mutex
...
### Описание
Interior mutability. RefCell для single-threaded. Mutex для multi-threaded. Синхронизация торговых операций.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Smart Pointers - RefCell и Mutex"
...
### Ключевые слова
`Smart Pointers - RefCell и Mutex`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
