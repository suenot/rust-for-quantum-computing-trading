# Глава 296: Event-driven архитектура
...
### Описание
Event sourcing. CQRS. Message queues. Kafka integration.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Event-driven архитектура"
...
### Ключевые слова
`Event-driven архитектура`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
