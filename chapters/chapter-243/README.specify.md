# Глава 243: Американские опционы
...
### Описание
Early exercise. Quantum approach. Approximations.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Американские опционы"
...
### Ключевые слова
`Американские опционы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
