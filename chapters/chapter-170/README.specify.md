...
### Описание
Managed jobs. Containers. Hyperparameters.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Braket - Hybrid Jobs"
...
### Ключевые слова
`Braket - Hybrid Jobs`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
