# Глава 075: Регуляторные требования
...
### Описание
MiFID II, Reg NMS. Reporting. Compliance в торговых системах.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Регуляторные требования"
...
### Ключевые слова
`Регуляторные требования`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
