# Глава 344: Quantum Bayesian inference
...
### Описание
Bayesian approach. Prior encoding. Posterior estimation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum Bayesian inference"
...
### Ключевые слова
`Quantum Bayesian inference`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
