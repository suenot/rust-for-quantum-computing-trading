...
### Описание
Photonic quantum computing. CV circuits. GBS.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Strawberry Fields"
...
### Ключевые слова
`Strawberry Fields`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
