# Глава 145: Qiskit - Noise modeling
...
### Описание
NoiseModel class. Realistic simulation. Error injection.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Noise modeling"
...
### Ключевые слова
`Qiskit - Noise modeling`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
