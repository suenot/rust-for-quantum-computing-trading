...
### Описание
Quantum entanglement. Bell states. EPR paradox. Rust entanglement simulation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Запутанность"
...
### Ключевые слова
`Запутанность`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
