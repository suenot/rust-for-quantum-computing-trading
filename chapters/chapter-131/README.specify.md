# Глава 131: Квантовая телепортация
...
### Описание
Teleportation protocol. Resource states. Circuit implementation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовая телепортация"
...
### Ключевые слова
`Квантовая телепортация`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
