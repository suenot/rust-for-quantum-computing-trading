# Глава 139: Карьера в квантовых вычислениях

## Техническое задание

### Название главы
Карьера в квантовых вычислениях
...
### Описание
Skills needed. Job market. Learning paths.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Карьера в квантовых вычислениях"
...
### Ключевые слова
`Карьера в квантовых вычислениях`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
