# Глава 189: Mitiq - Error mitigation
...
### Описание
Error mitigation library. ZNE. PEC. CDR.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Mitiq - Error mitigation"
...
### Ключевые слова
`Mitiq - Error mitigation`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
