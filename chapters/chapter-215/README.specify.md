# Глава 215: Azure Quantum - Pricing
...
### Описание
Credits. Per-shot pricing. Provider rates. Free tier.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Azure Quantum - Pricing"
...
### Ключевые слова
`Azure Quantum - Pricing`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
