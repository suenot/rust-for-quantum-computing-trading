# Глава 211: Azure Quantum - Quantinuum access

## Техническое задание

### Название главы
Azure Quantum - Quantinuum access
...
### Описание
H-Series systems. High fidelity. Enterprise focus.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Azure Quantum - Quantinuum access"
...
### Ключевые слова
`Azure Quantum - Quantinuum access`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
