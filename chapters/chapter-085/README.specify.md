...
### Описание
Quantum superposition. Hadamard gate. Probability amplitudes. Rust simulation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Суперпозиция"
...
### Ключевые слова
`Суперпозиция`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
