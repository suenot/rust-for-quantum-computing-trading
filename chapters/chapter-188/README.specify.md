# Глава 188: QuTiP - Quantum Toolbox
...
### Описание
Open quantum systems. Dynamics. Visualization.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "QuTiP - Quantum Toolbox"
...
### Ключевые слова
`QuTiP - Quantum Toolbox`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
