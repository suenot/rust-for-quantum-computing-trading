# Глава 157: Cirq - Advanced features

## Техническое задание

### Название главы
Cirq - Advanced features
...
### Описание
Custom gates. Decomposition. Optimization passes.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Cirq - Advanced features"
...
### Ключевые слова
`Cirq - Advanced features`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
