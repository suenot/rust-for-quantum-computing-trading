...
### Описание
Unit tests. Integration tests. Doc tests. Тестирование торговых стратегий.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Тестирование в Rust"
...
### Ключевые слова
`Тестирование в Rust`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
