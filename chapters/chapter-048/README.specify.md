...
### Описание
Bid-ask spread. Inventory risk. MM стратегии. Rust симулятор маркет-мейкера.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Market Making"
...
### Ключевые слова
`Market Making`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
