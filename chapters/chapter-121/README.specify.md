# Глава 121: Топологические квантовые вычисления
...
### Описание
Anyons. Braiding. Microsoft approach. Majorana qubits.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Топологические квантовые вычисления"
...
### Ключевые слова
`Топологические квантовые вычисления`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
