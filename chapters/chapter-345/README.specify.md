# Глава 345: Quantum sampling methods
...
### Описание
MCMC. Gibbs sampling. Financial simulation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum sampling methods"
...
### Ключевые слова
`Quantum sampling methods`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
