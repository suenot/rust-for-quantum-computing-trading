...
### Описание
Serde framework. JSON, YAML, TOML. Сериализация рыночных данных и конфигураций.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Сериализация - Serde"
...
### Ключевые слова
`Сериализация - Serde`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
