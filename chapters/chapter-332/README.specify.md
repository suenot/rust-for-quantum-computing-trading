...
### Описание
Quantum memory types. Coherence times. Applications.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовая память"
...
### Ключевые слова
`Квантовая память`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
