...
### Описание
Period finding predecessor. Exponential speedup. Rust simulation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Алгоритм Саймона"
...
### Ключевые слова
`Алгоритм Саймона`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
