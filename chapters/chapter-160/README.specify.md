...
### Описание
Q# types. Callables. User-defined types. Generics.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Q# - Type system"
...
### Ключевые слова
`Q# - Type system`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
