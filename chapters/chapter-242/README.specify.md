...
### Описание
European option circuit. Payoff function. Amplitude estimation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Европейские опционы"
...
### Ключевые слова
`Европейские опционы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
