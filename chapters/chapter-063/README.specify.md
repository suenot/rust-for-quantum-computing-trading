# Глава 063: Бэктестинг - Симуляция исполнения

## Техническое задание

### Название главы
Бэктестинг - Симуляция исполнения
...
### Описание
Slippage modeling. Fill simulation. Latency modeling. Rust simulator.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Бэктестинг - Симуляция исполнения"
...
### Ключевые слова
`Бэктестинг - Симуляция исполнения`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
