...
### Описание
Markowitz model. Efficient frontier. Capital allocation. Rust optimization.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Portfolio Theory"
...
### Ключевые слова
`Portfolio Theory`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
