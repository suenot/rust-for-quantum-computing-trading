# Глава 047: Order Book и Matching Engine

## Техническое задание

### Название главы
Order Book и Matching Engine
...
### Описание
Структура order book. Price-time priority. Matching algorithms. Rust реализация.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Order Book и Matching Engine"
...
### Ключевые слова
`Order Book и Matching Engine`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
