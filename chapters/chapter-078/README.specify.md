...
### Описание
Black-Scholes. Greeks. Implied volatility. Rust option pricer.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Options Pricing"
...
### Ключевые слова
`Options Pricing`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
