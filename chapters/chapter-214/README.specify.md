# Глава 214: Azure Quantum - Q# integration

## Техническое задание

### Название главы
Azure Quantum - Q# integration
...
### Описание
Native Q# support. Debugging. Profiling.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Azure Quantum - Q# integration"
...
### Ключевые слова
`Azure Quantum - Q# integration`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
