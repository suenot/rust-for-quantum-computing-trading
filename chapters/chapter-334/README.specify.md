# Глава 334: Распределённые квантовые вычисления
...
### Описание
Distributed quantum computing. Communication. Protocols.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Распределённые квантовые вычисления"
...
### Ключевые слова
`Распределённые квантовые вычисления`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
