...
### Описание
Conditionals. Loops. Recursion. Quantum control.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Q# - Control flow"
...
### Ключевые слова
`Q# - Control flow`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
