# Глава 190: Quantum transpilation
...
### Описание
Circuit optimization. Gate decomposition. Routing. Mapping.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum transpilation"
...
### Ключевые слова
`Quantum transpilation`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
