...
### Описание
Python framework. Compilers. Emulators. Hardware backends.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "ProjectQ"
...
### Ключевые слова
`ProjectQ`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
