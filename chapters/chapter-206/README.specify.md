...
### Описание
Per-task. Per-shot. Simulator pricing. Reserved capacity.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "AWS Braket - Pricing"
...
### Ключевые слова
`AWS Braket - Pricing`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
