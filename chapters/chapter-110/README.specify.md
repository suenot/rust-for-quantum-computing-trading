# Глава 110: Квантовая классификация
...
### Описание
Quantum SVM. Kernel methods. Feature maps.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовая классификация"
...
### Ключевые слова
`Квантовая классификация`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
