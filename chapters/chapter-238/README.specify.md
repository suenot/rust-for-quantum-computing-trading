# Глава 238: Квантовая оптимизация портфеля - Annealing

## Техническое задание

### Название главы
Квантовая оптимизация портфеля - Annealing
...
### Описание
D-Wave portfolio optimization. Embedding. Results.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовая оптимизация портфеля - Annealing"
...
### Ключевые слова
`Квантовая оптимизация портфеля - Annealing`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
