...
### Описание
Quantum annealing. Hybrid solver. Ocean SDK. Leap access.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "D-Wave Leap"
...
### Ключевые слова
`D-Wave Leap`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
