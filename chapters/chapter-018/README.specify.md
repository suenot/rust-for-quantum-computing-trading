# Глава 018: Traits - Продвинутые концепции

## Техническое задание

### Название главы
Traits - Продвинутые концепции
...
### Описание
Associated types. Trait bounds. Supertraits. Полиморфизм для торговых стратегий.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Traits - Продвинутые концепции"
...
### Ключевые слова
`Traits - Продвинутые концепции`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
