...
### Описание
Derive macros. Attribute macros. Function-like macros. Автогенерация кода для стратегий.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Макросы - Procedural"
...
### Ключевые слова
`Макросы - Procedural`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
