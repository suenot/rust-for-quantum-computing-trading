# Глава 300: gRPC для высокопроизводительных сервисов
...
### Описание
Protocol buffers. Streaming. Performance. Rust tonic.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "gRPC для высокопроизводительных сервисов"
...
### Ключевые слова
`gRPC для высокопроизводительных сервисов`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
