# Глава 349: Quantum computer vision
...
### Описание
Image encoding. Classification. Object detection.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum computer vision"
...
### Ключевые слова
`Quantum computer vision`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
