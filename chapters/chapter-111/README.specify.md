# Глава 111: Quantum Neural Networks
...
### Описание
Parameterized circuits. Training methods. Barren plateaus.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum Neural Networks"
...
### Ключевые слова
`Quantum Neural Networks`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
