...
### Описание
State vector. Density matrix. Clifford simulator.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Cirq - Simulators"
...
### Ключевые слова
`Cirq - Simulators`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
