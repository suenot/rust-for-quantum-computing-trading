# Глава 134: Постквантовая криптография
...
### Описание
Lattice-based crypto. NIST standards. Rust implementations.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Постквантовая криптография"
...
### Ключевые слова
`Постквантовая криптография`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
