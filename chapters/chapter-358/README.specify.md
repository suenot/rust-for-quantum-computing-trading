# Глава 358: Регулирование квантовых технологий
...
### Описание
Policy landscape. Export controls. National strategies.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Регулирование квантовых технологий"
...
### Ключевые слова
`Регулирование квантовых технологий`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
