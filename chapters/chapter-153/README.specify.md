# Глава 153: Cirq - Установка и основы

## Техническое задание

### Название главы
Cirq - Установка и основы
...
### Описание
Google Cirq. Installation. Qubits and gates. Circuits.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Cirq - Установка и основы"
...
### Ключевые слова
`Cirq - Установка и основы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
