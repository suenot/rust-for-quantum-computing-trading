# Глава 023: Многопоточность - Основы
...
### Описание
std::thread. Создание потоков. Join handles. Параллельная обработка рыночных данных.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Многопоточность - Основы"
...
### Ключевые слова
`Многопоточность - Основы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
