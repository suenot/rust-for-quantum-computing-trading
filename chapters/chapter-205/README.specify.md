# Глава 205: AWS Braket - Hybrid Jobs
...
### Описание
Containerized algorithms. Classical processing. Iteration.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "AWS Braket - Hybrid Jobs"
...
### Ключевые слова
`AWS Braket - Hybrid Jobs`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
