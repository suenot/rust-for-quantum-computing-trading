# Глава 266: Квантовая оптимизация ESG

## Техническое задание

### Название главы
Квантовая оптимизация ESG
...
### Описание
ESG constraints. Multi-objective. Pareto frontier.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовая оптимизация ESG"
...
### Ключевые слова
`Квантовая оптимизация ESG`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
