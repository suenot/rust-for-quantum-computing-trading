# Глава 113: Quantum Boltzmann Machines
...
### Описание
QBM architecture. Sampling. Generative models.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum Boltzmann Machines"
...
### Ключевые слова
`Quantum Boltzmann Machines`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
