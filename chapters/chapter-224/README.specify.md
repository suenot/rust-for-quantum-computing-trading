...
### Описание
Direct access. TKET. High fidelity. Enterprise.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantinuum - H-Series"
...
### Ключевые слова
`Quantinuum - H-Series`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
