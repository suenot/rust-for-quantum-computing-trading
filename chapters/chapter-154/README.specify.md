# Глава 154: Cirq - Circuit building
...
### Описание
Moments. Devices. Noise. Simulation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Cirq - Circuit building"
...
### Ключевые слова
`Cirq - Circuit building`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
