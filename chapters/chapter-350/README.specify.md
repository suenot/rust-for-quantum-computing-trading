# Глава 350: Интеграция с классическим HPC

## Техническое задание

### Название главы
Интеграция с классическим HPC
...
### Описание
HPC integration. MPI. Slurm. Hybrid workflows.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Интеграция с классическим HPC"
...
### Ключевые слова
`Интеграция с классическим HPC`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
