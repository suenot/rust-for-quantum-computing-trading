...
### Описание
Уникальная система владения Rust. Move semantics. Правила владения. Почему это критично для торговых систем реального времени.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Владение (Ownership)"
...
### Ключевые слова
`Владение (Ownership)`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
