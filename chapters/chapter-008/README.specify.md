...
### Описание
Определение структур. Tuple structs. Unit structs. Моделирование финансовых инструментов (акции, опционы, фьючерсы).

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Структуры (Structs)"
...
### Ключевые слова
`Структуры (Structs)`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
