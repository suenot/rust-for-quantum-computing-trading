# Глава 277: Корреляционный анализ
...
### Описание
Correlation estimation. Quantum speedup. Portfolio applications.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Корреляционный анализ"
...
### Ключевые слова
`Корреляционный анализ`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
