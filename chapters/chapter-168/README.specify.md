# Глава 168: PennyLane - Optimization
...
### Описание
Built-in optimizers. Gradient-free methods. QNG.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "PennyLane - Optimization"
...
### Ключевые слова
`PennyLane - Optimization`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
