# Глава 059: Статистический анализ
...
### Описание
Returns, volatility, correlation. Rust статистические функции.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Статистический анализ"
...
### Ключевые слова
`Статистический анализ`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
