# Глава 033: Cargo - Управление проектами

## Техническое задание

### Название главы
Cargo - Управление проектами
...
### Описание
Cargo.toml. Dependencies. Features. Workspaces. Организация торгового проекта.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Cargo - Управление проектами"
...
### Ключевые слова
`Cargo - Управление проектами`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
