# Глава 239: Квантовый Монте-Карло - Теория

## Техническое задание

### Название главы
Квантовый Монте-Карло - Теория
...
### Описание
Quantum speedup. Amplitude estimation. Error bounds.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовый Монте-Карло - Теория"
...
### Ключевые слова
`Квантовый Монте-Карло - Теория`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
