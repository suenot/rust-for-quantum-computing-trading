# Глава 163: Q# - Resource estimation

## Техническое задание

### Название главы
Q# - Resource estimation
...
### Описание
Azure Quantum RE. Logical qubits. T-gates.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Q# - Resource estimation"
...
### Ключевые слова
`Q# - Resource estimation`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
