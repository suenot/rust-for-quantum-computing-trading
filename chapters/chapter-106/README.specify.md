...
### Описание
9-qubit code. Error correction procedure. Rust simulation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Код Шора"
...
### Ключевые слова
`Код Шора`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
