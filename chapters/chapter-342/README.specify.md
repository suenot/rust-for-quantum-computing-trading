# Глава 342: Quantum autoencoders
...
### Описание
Compression. Denoising. Feature extraction.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum autoencoders"
...
### Ключевые слова
`Quantum autoencoders`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
