...
### Описание
Xanadu PennyLane. Quantum nodes. Devices. Gradients.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "PennyLane - Basics"
...
### Ключевые слова
`PennyLane - Basics`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
