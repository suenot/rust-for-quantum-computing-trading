# Глава 247: Credit Risk Analysis
...
### Описание
Default probability. Credit scoring. Quantum enhancement.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Credit Risk Analysis"
...
### Ключевые слова
`Credit Risk Analysis`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
