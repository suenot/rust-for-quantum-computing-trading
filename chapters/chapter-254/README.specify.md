# Глава 254: Квантовое обнаружение аномалий
...
### Описание
Fraud detection. Anomaly scoring. Quantum speedup.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовое обнаружение аномалий"
...
### Ключевые слова
`Квантовое обнаружение аномалий`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
