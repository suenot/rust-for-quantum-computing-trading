...
### Описание
Unsafe блоки. Raw pointers. FFI basics. Оптимизации для критичных по времени операций.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Unsafe Rust"
...
### Ключевые слова
`Unsafe Rust`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
