# Глава 150: Qiskit - Machine Learning
...
### Описание
Qiskit ML. Quantum kernels. QNN. Training.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Machine Learning"
...
### Ключевые слова
`Qiskit - Machine Learning`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
