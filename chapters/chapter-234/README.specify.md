# Глава 234: Ising model для финансов

## Техническое задание

### Название главы
Ising model для финансов
...
### Описание
Spin glass analogy. Hamiltonian formulation. Energy landscape.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Ising model для финансов"
...
### Ключевые слова
`Ising model для финансов`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
