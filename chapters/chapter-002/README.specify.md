# Глава 002: Базовые типы данных в Rust
...
### Описание
Примитивные типы (i32, f64, bool, char), составные типы (tuple, array). Числовые типы для финансовых расчётов. Точность вычислений с плавающей точкой.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Базовые типы данных в Rust"
...
### Ключевые слова
`Базовые типы данных в Rust`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
