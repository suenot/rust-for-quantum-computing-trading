# Глава 114: Квантовые случайные числа
...
### Описание
QRNG principles. Certifiable randomness. Rust QRNG integration.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовые случайные числа"
...
### Ключевые слова
`Квантовые случайные числа`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
