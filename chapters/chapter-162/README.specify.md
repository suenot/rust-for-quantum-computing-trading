...
### Описание
Standard library. Numerics. Chemistry. Machine learning.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Q# - Libraries"
...
### Ключевые слова
`Q# - Libraries`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
