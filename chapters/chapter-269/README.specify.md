# Глава 269: Регуляторный капитал
...
### Описание
Capital requirements. Quantum computation. Compliance.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Регуляторный капитал"
...
### Ключевые слова
`Регуляторный капитал`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
