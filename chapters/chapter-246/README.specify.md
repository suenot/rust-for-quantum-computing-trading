# Глава 246: Conditional VaR (CVaR)
...
### Описание
Expected shortfall. Quantum estimation. Tail risk.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Conditional VaR (CVaR)"
...
### Ключевые слова
`Conditional VaR (CVaR)`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
