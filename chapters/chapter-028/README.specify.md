...
### Описание
Stream trait. Асинхронные итераторы. Обработка потоковых рыночных данных в реальном времени.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Async Streams"
...
### Ключевые слова
`Async Streams`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
