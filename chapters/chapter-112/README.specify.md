# Глава 112: Quantum Principal Component Analysis
...
### Описание
qPCA algorithm. Exponential speedup. Density matrices.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum Principal Component Analysis"
...
### Ключевые слова
`Quantum Principal Component Analysis`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
