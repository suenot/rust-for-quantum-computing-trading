...
### Описание
Qiskit Optimization. QUBO. Converters. Classical solvers.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Optimization"
...
### Ключевые слова
`Qiskit - Optimization`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
