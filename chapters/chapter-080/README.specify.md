# Глава 080: Machine Learning для трейдинга
...
### Описание
ML pipelines. Feature engineering. Rust ML ecosystem.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Machine Learning для трейдинга"
...
### Ключевые слова
`Machine Learning для трейдинга`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
