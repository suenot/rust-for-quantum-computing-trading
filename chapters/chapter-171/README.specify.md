# Глава 171: Braket - Noise simulation

## Техническое задание

### Название главы
Braket - Noise simulation
...
### Описание
Noise models. Error types. Kraus operators.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Braket - Noise simulation"
...
### Ключевые слова
`Braket - Noise simulation`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
