...
### Описание
Асинхронное программирование. Future trait. async fn. Неблокирующие операции с биржевыми API.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Async/Await - Основы"
...
### Ключевые слова
`Async/Await - Основы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
