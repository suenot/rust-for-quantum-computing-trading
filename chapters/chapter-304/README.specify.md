...
### Описание
Command-line tools. clap crate. Interactive prompts. Scripting.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "CLI инструменты"
...
### Ключевые слова
`CLI инструменты`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
