...
### Описание
Circuit model. Wire diagrams. Gate sequences. Rust circuit builder.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовые схемы"
...
### Ключевые слова
`Квантовые схемы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
