...
### Описание
Direct IonQ access. Aria, Forte. API. Native gates.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "IonQ Direct"
...
### Ключевые слова
`IonQ Direct`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
