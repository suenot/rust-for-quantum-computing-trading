# Глава 070: Execution Algorithms
...
### Описание
TWAP, VWAP, Implementation Shortfall. Rust exec algos.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Execution Algorithms"
...
### Ключевые слова
`Execution Algorithms`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
