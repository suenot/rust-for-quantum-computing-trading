# Глава 158: Cirq - TensorFlow Quantum
...
### Описание
TFQ integration. Hybrid models. Training.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Cirq - TensorFlow Quantum"
...
### Ключевые слова
`Cirq - TensorFlow Quantum`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
