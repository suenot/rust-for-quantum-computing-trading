...
### Описание
REST endpoints. Authentication. Rate limiting. Rust HTTP клиент для бирж.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "REST API бирж"
...
### Ключевые слова
`REST API бирж`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
