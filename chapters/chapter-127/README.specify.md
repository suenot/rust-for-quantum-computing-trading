# Глава 127: Tensor Network симуляторы

## Техническое задание

### Название главы
Tensor Network симуляторы
...
### Описание
MPS, PEPS. Efficient simulation. Rust tensor networks.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Tensor Network симуляторы"
...
### Ключевые слова
`Tensor Network симуляторы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
