...
### Описание
macro_rules! Паттерны макросов. Метапрограммирование. DSL для торговых правил.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Макросы - Declarative"
...
### Ключевые слова
`Макросы - Declarative`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
