...
### Описание
License selection. Compliance. Dependencies audit.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Лицензирование"
...
### Ключевые слова
`Лицензирование`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
