# Глава 116: Квантовое моделирование
...
### Описание
Hamiltonian simulation. Trotterization. Chemistry applications.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовое моделирование"
...
### Ключевые слова
`Квантовое моделирование`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
