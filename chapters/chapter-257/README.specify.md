...
### Описание
Quantum linear regression. Feature selection. Performance.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовая регрессия"
...
### Ключевые слова
`Квантовая регрессия`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
