# Глава 166: PennyLane - ML integration
...
### Описание
PyTorch, TensorFlow integration. Hybrid models.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "PennyLane - ML integration"
...
### Ключевые слова
`PennyLane - ML integration`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
