# Глава 088: Квантовые вентили - Многокубитные

## Техническое задание

### Название главы
Квантовые вентили - Многокубитные
...
### Описание
CNOT, CZ, SWAP. Toffoli gate. Controlled operations. Rust implementation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовые вентили - Многокубитные"
...
### Ключевые слова
`Квантовые вентили - Многокубитные`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
