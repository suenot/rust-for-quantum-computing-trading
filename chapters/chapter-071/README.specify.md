...
### Описание
Multi-venue routing. Best execution. Rust SOR implementation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Smart Order Routing"
...
### Ключевые слова
`Smart Order Routing`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
