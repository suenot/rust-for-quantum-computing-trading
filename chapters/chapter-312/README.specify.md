...
### Описание
API documentation. Rustdoc. Examples. Tutorials.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Документация API"
...
### Ключевые слова
`Документация API`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
