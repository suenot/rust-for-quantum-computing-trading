...
### Описание
Rustdoc. Markdown в комментариях. Примеры в документации. Документирование торгового API.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Документация"
...
### Ключевые слова
`Документация`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
