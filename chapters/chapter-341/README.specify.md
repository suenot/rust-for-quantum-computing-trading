# Глава 341: Quantum Wasserstein GAN
...
### Описание
QWGAN. Optimal transport. Financial applications.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum Wasserstein GAN"
...
### Ключевые слова
`Quantum Wasserstein GAN`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
