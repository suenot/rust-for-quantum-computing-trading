...
### Описание
QASM syntax. Gates. Measurements. Barriers.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "OpenQASM 2.0"
...
### Ключевые слова
`OpenQASM 2.0`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
