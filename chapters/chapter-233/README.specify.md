...
### Описание
Quadratic Unconstrained Binary Optimization. Portfolio mapping.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "QUBO для финансов"
...
### Ключевые слова
`QUBO для финансов`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
