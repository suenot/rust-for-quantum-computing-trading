# Глава 148: Qiskit - Algorithms library
...
### Описание
Built-in algorithms. VQE, QAOA, Grover. Usage examples.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Algorithms library"
...
### Ключевые слова
`Qiskit - Algorithms library`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
