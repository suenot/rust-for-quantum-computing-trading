# Глава 003: Переменные и неизменяемость
...
### Описание
Концепция immutability по умолчанию, mut keyword. Shadowing переменных. Константы и статические переменные. Паттерны для финансовых данных.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Переменные и неизменяемость"
...
### Ключевые слова
`Переменные и неизменяемость`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
