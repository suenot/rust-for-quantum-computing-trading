# Глава 135: Квантовые вычисления и блокчейн
...
### Описание
Quantum threats to blockchain. Quantum-resistant ledgers. Solutions.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовые вычисления и блокчейн"
...
### Ключевые слова
`Квантовые вычисления и блокчейн`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
