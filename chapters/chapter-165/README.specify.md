...
### Описание
Automatic differentiation. Parameter-shift rule. Backprop.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "PennyLane - Autodiff"
...
### Ключевые слова
`PennyLane - Autodiff`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
