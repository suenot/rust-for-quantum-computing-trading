# Глава 309: Property-based testing
...
### Описание
QuickCheck. Hypothesis. Invariant testing. Edge cases.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Property-based testing"
...
### Ключевые слова
`Property-based testing`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
