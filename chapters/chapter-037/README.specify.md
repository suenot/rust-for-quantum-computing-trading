# Глава 037: Числовые вычисления - ndarray

## Техническое задание

### Название главы
Числовые вычисления - ndarray
...
### Описание
ndarray crate. N-мерные массивы. Операции с матрицами. Финансовые расчёты.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Числовые вычисления - ndarray"
...
### Ключевые слова
`Числовые вычисления - ndarray`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
