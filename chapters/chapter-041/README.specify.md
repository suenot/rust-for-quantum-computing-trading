# Глава 041: Структура финансовых рынков
...
### Описание
Типы рынков (spot, derivatives). Участники рынка. Регуляторы. Глобальная структура.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Структура финансовых рынков"
...
### Ключевые слова
`Структура финансовых рынков`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
