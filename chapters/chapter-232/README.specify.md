# Глава 232: Кодирование финансовых данных
...
### Описание
Amplitude encoding. Basis encoding. QRAM. Data loading.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Кодирование финансовых данных"
...
### Ключевые слова
`Кодирование финансовых данных`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
