# Глава 314: Open Source best practices
...
### Описание
Code quality. Contributing guidelines. Community building.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Open Source best practices"
...
### Ключевые слова
`Open Source best practices`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
