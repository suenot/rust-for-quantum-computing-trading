...
### Описание
Adiabatic theorem. D-Wave systems. Optimization applications.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Quantum Annealing"
...
### Ключевые слова
`Quantum Annealing`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
