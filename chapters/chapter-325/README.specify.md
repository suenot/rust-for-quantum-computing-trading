...
### Описание
Metrics. Logging. Tracing. OpenTelemetry. Grafana.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Observability"
...
### Ключевые слова
`Observability`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
