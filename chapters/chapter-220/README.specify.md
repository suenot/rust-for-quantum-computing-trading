...
### Описание
Photonic quantum. Borealis access. Strawberry Fields. PennyLane.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Xanadu Cloud"
...
### Ключевые слова
`Xanadu Cloud`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
