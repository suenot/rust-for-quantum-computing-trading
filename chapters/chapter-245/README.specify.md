...
### Описание
Quantum VaR calculation. Risk quantification. Speedup analysis.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Value at Risk (VaR)"
...
### Ключевые слова
`Value at Risk (VaR)`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
