# Глава 237: Квантовая оптимизация портфеля - VQE

## Техническое задание

### Название главы
Квантовая оптимизация портфеля - VQE
...
### Описание
VQE approach. Ansatz design. Convergence.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Квантовая оптимизация портфеля - VQE"
...
### Ключевые слова
`Квантовая оптимизация портфеля - VQE`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
