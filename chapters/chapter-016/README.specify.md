...
### Описание
Анонимные функции. Захват окружения. Fn, FnMut, FnOnce traits. Колбэки для торговых событий.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Замыкания (Closures)"
...
### Ключевые слова
`Замыкания (Closures)`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
