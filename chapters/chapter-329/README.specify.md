...
### Описание
Provider evaluation. Contract negotiation. Risk mitigation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Vendor management"
...
### Ключевые слова
`Vendor management`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
