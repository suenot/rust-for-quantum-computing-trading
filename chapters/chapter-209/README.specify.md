# Глава 209: Azure Quantum - Providers
...
### Описание
IonQ, Quantinuum, Pasqal, Rigetti. Provider comparison.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Azure Quantum - Providers"
...
### Ключевые слова
`Azure Quantum - Providers`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
