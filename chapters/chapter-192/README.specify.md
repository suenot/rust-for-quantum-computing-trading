# Глава 192: IBM Quantum - Hardware
...
### Описание
Available systems. Qubit counts. Connectivity. Error rates.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "IBM Quantum - Hardware"
...
### Ключевые слова
`IBM Quantum - Hardware`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
