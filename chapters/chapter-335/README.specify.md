# Глава 335: Blind quantum computing
...
### Описание
Privacy-preserving. Verification. Delegated computation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Blind quantum computing"
...
### Ключевые слова
`Blind quantum computing`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
