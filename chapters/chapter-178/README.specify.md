# Глава 178: Rust Quantum Libraries - Обзор

## Техническое задание

### Название главы
Rust Quantum Libraries - Обзор
...
### Описание
Quantum computing in Rust. Available crates. Ecosystem.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Rust Quantum Libraries - Обзор"
...
### Ключевые слова
`Rust Quantum Libraries - Обзор`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
