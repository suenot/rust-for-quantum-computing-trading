...
### Описание
Finance module. Portfolio optimization. Option pricing.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Qiskit - Finance"
...
### Ключевые слова
`Qiskit - Finance`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
