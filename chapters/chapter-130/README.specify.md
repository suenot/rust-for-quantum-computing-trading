...
### Описание
Zero noise extrapolation. Probabilistic error cancellation. Rust implementation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Митигация ошибок"
...
### Ключевые слова
`Митигация ошибок`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
