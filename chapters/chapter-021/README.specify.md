# Глава 021: Smart Pointers - Rc и Arc

## Техническое задание

### Название главы
Smart Pointers - Rc и Arc
...
### Описание
Reference counting. Shared ownership. Thread-safe Arc. Разделяемые рыночные данные между стратегиями.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Smart Pointers - Rc и Arc"
...
### Ключевые слова
`Smart Pointers - Rc и Arc`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
