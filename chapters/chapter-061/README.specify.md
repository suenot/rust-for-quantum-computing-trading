# Глава 061: Бэктестинг - Архитектура

## Техническое задание

### Название главы
Бэктестинг - Архитектура
...
### Описание
Event-driven backtesting. Vectorized backtesting. Rust фреймворк.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Бэктестинг - Архитектура"
...
### Ключевые слова
`Бэктестинг - Архитектура`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
