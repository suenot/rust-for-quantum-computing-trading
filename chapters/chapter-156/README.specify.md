# Глава 156: Cirq - Google Hardware

## Техническое задание

### Название главы
Cirq - Google Hardware
...
### Описание
Quantum Engine. Device specifications. Job submission.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Cirq - Google Hardware"
...
### Ключевые слова
`Cirq - Google Hardware`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
