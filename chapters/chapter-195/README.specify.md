...
### Описание
Primitive execution. Sessions. Batching. Optimization levels.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "IBM Quantum - Runtime"
...
### Ключевые слова
`IBM Quantum - Runtime`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
