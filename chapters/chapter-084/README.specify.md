...
### Описание
Qubit vs classical bit. Bloch sphere. State representation. Rust qubit simulation.

### Цели обучения
После изучения этой главы читатель должен:
1. Понимать ключевые концепции, связанные с темой "Кубиты - Основы"
...
### Ключевые слова
`Кубиты - Основы`, Rust, квантовые вычисления, алготрейдинг, финансовые рынки
